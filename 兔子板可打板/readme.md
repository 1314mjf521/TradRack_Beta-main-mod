...
# 新增拼板文件
![新增拼版正面](./img/新增拼版正面.png)
![新增拼版背面](./img/新增拼版反面.png)

# STM32 主板双版本
![STM32双板本](./img/STM32优化正面.png)
![STM32双板本](./img/STM32优化背面.png)
![STM32双板本](./img/STM32双输入电路.png)
![STM32双板本](./img/STM32双输入电路背面.png)  
![STM32双板本](./img/STM32_1.3.4.png)
...
##  2024-06-16 RP2040-zero 1.6.2 贴片版本优化，新增合宙RP2040主板布局（暂时没时间截图就不放了）  
##  2024-07-07 RP2040-zero 1.6.2 贴片版本优化，新增合并版本文件，并完成相关验证，疯狂叠加电源板（不想买2.5的DCDC板可以自行购买零件）   
##  2024-07-21 STM32兔子版上线，成本20以内搞定还带主控,支持兔二9限位加上1个RGB接口,该拼版就拼版不要犹豫    